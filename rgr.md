...
Діаграма взаємодії для 3 лабораторної роботи.

![](assets/img/diagram-l3.png)

#### Наша діаграма містить три шари:
1. Client
2. Server
3. Database
...
#### Кроки користувача:
##### 1. Шар Client:
  1. Користувач викликає метод клієнту
  2. Функція http робить запит на сервер та повертає результат
##### 2. Шар Server:
  1. Запит приходить на ApiServer
  2. На route “/restaurant” навішуємо функцію handleFunc, яка в залежномті від методу запиту (Get, Post) викличе функцію handleGetMenu або handleAddNewOrder
  3. Handler викликає GetMenu або ж AddNewOrder структури Store
  4. Store робить запит до бази даних, для цього у нас є DbConnection яке встановлює з’єднання з базою даних
